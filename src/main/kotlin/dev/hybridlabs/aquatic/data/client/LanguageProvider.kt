...
class LanguageProvider(output: FabricDataOutput) : FabricLanguageProvider(output) {
    override fun generateTranslations(builder: TranslationBuilder) {
        ...
        mapOf(
            ...
            HybridAquaticBlocks.THERMAL_VENT_SHAFT to "Thermal Vent Shaft",
        ...
        mapOf(
            ...
            HybridAquaticItems.SURGEONFISH_ORANGESHOULDER to "Orangeshoulder Sohal",
            ...
            HybridAquaticItems.COCONUT to "Coconut",
            HybridAquaticItems.COCONUT_HALF to "Coconut Half",
