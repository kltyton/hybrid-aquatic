...
object HybridAquaticItems {
    ...
    val NAUTILUS_HELMET: Item = register("seashell_helmet", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.HELMET, FabricItemSettings().maxCount(1)))
    val NAUTILUS_PAULDRONS: Item = register("seashell_pauldrons", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.CHESTPLATE, FabricItemSettings().maxCount(1)))
