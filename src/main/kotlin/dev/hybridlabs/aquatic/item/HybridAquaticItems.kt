...
object HybridAquaticItems {
    ...
    val NAUTILUS_HELMET: Item = register("nautilus_helmet", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.HELMET, FabricItemSettings().maxCount(1)))
    val NAUTILUS_PAULDRONS: Item = register("nautilus_pauldrons", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.CHESTPLATE, FabricItemSettings().maxCount(1)))
    ...
    val RAW_LOBSTER_TAIL = register("raw_lobster_tail",
        Item(
            FabricItemSettings()
                .food(
                    FoodComponent.Builder()
    ...
    val COOKED_LOBSTER_TAIL = register("cooked_lobster_tail",
        Item(
            FabricItemSettings()
                .food(
                    FoodComponent.Builder()
    ...
    val UNICORNFISH = register("unicorn_fish",
        Item(
            FabricItemSettings()
                .food(
                    FoodComponent.Builder()
    ...
    // fish spawn eggs
    val AFRICAN_BUTTERFLY_SPAWN_EGG = registerSpawnEgg("african_butterfly_spawn_egg", HybridAquaticEntityTypes.AFRICAN_BUTTERFLY, 0x4d4848, 0xc4faff)
    ...
    val CARP_SPAWN_EGG = registerSpawnEgg("carp_spawn_egg", HybridAquaticEntityTypes.CARP, 0xefedf6, 0xff9166)
    ...
    val MACKEREL_SPAWN_EGG = registerSpawnEgg("mackerel_spawn_egg", HybridAquaticEntityTypes.MACKEREL, 0xc0e4f7, 0x537da8)
    ...
    val KARKINOS_SPAWN_EGG = registerSpawnEgg("karkinos_spawn_egg", HybridAquaticEntityTypes.KARKINOS, 0xfff4dd, 0xffd16b)
