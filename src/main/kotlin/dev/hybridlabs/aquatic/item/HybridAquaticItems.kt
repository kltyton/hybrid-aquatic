...
object HybridAquaticItems {
    ...
    val SEASHELL_HELMET: Item = register("seashell_helmet", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.HELMET, FabricItemSettings().maxCount(1)))
    val SEASHELL_PAULDRONS: Item = register("seashell_pauldrons", SeashellArmorItem(HybridAquaticArmorMaterials.SEASHELL, ArmorItem.Type.CHESTPLATE, FabricItemSettings().maxCount(1)))
    ...
    val PARROTFISH_SPAWN_EGG = registerSpawnEgg("parrotfish_spawn_egg", HybridAquaticEntityTypes.PARROTFISH, 0x4d4848, 0xc4faff)
