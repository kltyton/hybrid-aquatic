...
object EntityBiomeModifications {
    init {
        // fish
        addFish(HybridAquaticEntityTypes.AFRICAN_BUTTERFLY, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 1, 1, 1)
        addFish(HybridAquaticEntityTypes.BETTA, listOf(HybridAquaticBiomeTags.SWAMPLAND), 1, 1, 1)
        ...
        addFish(HybridAquaticEntityTypes.STINGRAY, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 2)
        addFish(HybridAquaticEntityTypes.MANTA_RAY, listOf(HybridAquaticBiomeTags.DEEP_WARM_OCEANS), 3, 1, 1)
        addFish(HybridAquaticEntityTypes.SURGEONFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 5, 1, 3)
        ...
        addFish(HybridAquaticEntityTypes.DISCUS, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 1, 1)
        addFish(HybridAquaticEntityTypes.FLASHLIGHT_FISH, listOf(HybridAquaticBiomeTags.ALL_DEEP_OCEANS), 5, 1, 5)
        addFish(HybridAquaticEntityTypes.GOURAMI, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 1, 1)
        ...
        addFish(HybridAquaticEntityTypes.NEEDLEFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 3)
        addFish(HybridAquaticEntityTypes.MACKEREL, listOf(HybridAquaticBiomeTags.DEEP_COLD_OCEANS), 5, 3, 5)
        addFish(HybridAquaticEntityTypes.OPAH, listOf(HybridAquaticBiomeTags.DEEP_WARM_OCEANS), 3, 1, 1)
        addFish(HybridAquaticEntityTypes.OSCAR, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 1, 1, 1)
        addFish(HybridAquaticEntityTypes.OARFISH, listOf(HybridAquaticBiomeTags.ALL_DEEP_OCEANS), 1, 1, 1)
        addFish(HybridAquaticEntityTypes.PIRANHA, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 5, 2, 5)
        ...
        addFish(HybridAquaticEntityTypes.TETRA, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 2, 3)
        addFish(HybridAquaticEntityTypes.TIGER_BARB, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 2, 3)
        addFish(HybridAquaticEntityTypes.TOADFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 1, 1, 1)
        addFish(HybridAquaticEntityTypes.TRIGGERFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 1)
        addFish(HybridAquaticEntityTypes.TUNA, listOf(HybridAquaticBiomeTags.ALL_DEEP_OCEANS), 5, 1, 3)
        addFish(HybridAquaticEntityTypes.DANIO, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 2, 3)
        ...
        addJelly(HybridAquaticEntityTypes.MOON_JELLYFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 5, 1, 2)
        addJelly(HybridAquaticEntityTypes.MAUVE_STINGER, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 2)
        addJelly(HybridAquaticEntityTypes.FRIED_EGG_JELLYFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 2)
        addJelly(HybridAquaticEntityTypes.CAULIFLOWER_JELLYFISH, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 2)
        ...
        // underground jellies
        addUndergroundJelly(HybridAquaticEntityTypes.ATOLLA_JELLYFISH, listOf(HybridAquaticBiomeTags.ALL_DEEP_OCEANS), 1, 1, 2)

        // sharks
        addShark(HybridAquaticEntityTypes.GREAT_WHITE_SHARK, listOf(HybridAquaticBiomeTags.DEEP_WARM_OCEANS), 3, 1, 1)
        addShark(HybridAquaticEntityTypes.TIGER_SHARK, listOf(HybridAquaticBiomeTags.WARM_OCEANS), 3, 1, 2)
        ...
        // crustaceans
        addCrustacean(HybridAquaticEntityTypes.DUNGENESS_CRAB, listOf(HybridAquaticBiomeTags.DUNGENESS_CRAB_SPAWN_BIOMES), 5, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.HERMIT_CRAB, listOf(HybridAquaticBiomeTags.TROPICAL_BEACHES), 3, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.FIDDLER_CRAB, listOf(HybridAquaticBiomeTags.SWAMPLAND), 5, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.GHOST_CRAB, listOf(HybridAquaticBiomeTags.GHOST_CRAB_SPAWN_BIOMES), 5, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.HORSESHOE_CRAB, listOf(HybridAquaticBiomeTags.ALL_WARM_OCEANS), 1, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.LIGHTFOOT_CRAB, listOf(HybridAquaticBiomeTags.LIGHTFOOT_CRAB_SPAWN_BIOMES), 3, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.FLOWER_CRAB, listOf(HybridAquaticBiomeTags.FLOWER_CRAB_SPAWN_BIOMES), 5, 1, 2)
        addCrustacean(HybridAquaticEntityTypes.VAMPIRE_CRAB, listOf(HybridAquaticBiomeTags.TROPICAL_FRESHWATER), 3, 1, 2)
        ...
        addCrustacean(HybridAquaticEntityTypes.COCONUT_CRAB, listOf(HybridAquaticBiomeTags.TROPICAL_BEACHES), 3, 1, 1)
