...
class DenseSargassumFeature(codec: Codec<DenseSargassumFeatureConfig>?) :
    Feature<DenseSargassumFeatureConfig>(codec) {
    override fun generate(context: FeatureContext<DenseSargassumFeatureConfig>): Boolean {
        var i = 0
