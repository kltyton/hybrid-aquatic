...
class DenseKelpWarmFeature(codec: Codec<DenseKelpWarmFeatureConfig>?) :
    Feature<DenseKelpWarmFeatureConfig>(codec) {
    override fun generate(context: FeatureContext<DenseKelpWarmFeatureConfig>): Boolean {
        var i = 0
