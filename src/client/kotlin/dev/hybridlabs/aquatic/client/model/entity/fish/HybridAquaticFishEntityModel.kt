...
abstract class HybridAquaticFishEntityModel<T: HybridAquaticFishEntity> (private val id: String) : GeoModel<T>() {
    override fun getModelResource(animatable: T?): Identifier {
        ...
        if (variant != null && !variant.ignore.contains(MODEL))
            return Identifier(HybridAquatic.MOD_ID, "geo/${id}_${variant.providedVariant}.geo.json")
    ...
    override fun getTextureResource(animatable: T?): Identifier {
        ...
        if (variant != null && !variant.ignore.contains(TEXTURE))
            return Identifier(HybridAquatic.MOD_ID, "textures/entity/${id}_${variant.providedVariant}.png")
    ...
    override fun getAnimationResource(animatable: T?): Identifier {
        ...
        if (variant != null && !variant.ignore.contains(ANIMATION))
            return Identifier(HybridAquatic.MOD_ID, "animations/${id}_${variant.providedVariant}.animation.json")
